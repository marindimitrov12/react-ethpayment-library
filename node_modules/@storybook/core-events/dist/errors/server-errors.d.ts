...
declare class MainFileMissingError extends StorybookError {
    ...
    readonly code = 6;
    readonly stack = "";
    readonly documentation = "https://storybook.js.org/docs/configure";
    constructor(data: {
        location: string;
    });
    template(): string;
