...
${input}`);let match2=input.match(firstLineRegex);if(!match2)return import_react25.default.createElement(import_react25.Fragment,null,input);let[,type,name]=match2,rawLines=input.split(/\n/).slice(1),[,...lines]=rawLines.map(line=>{let result=line.match(linesRegexChromium)||line.match(linesRegexFirefox)||line.match(linesRegexSafari);return result?{name:(result[1]||"").replace("/<",""),location:result[2].replace(document3.location.origin,"")}:null}).filter(Boolean);return import_react25.default.createElement(import_react25.Fragment,null,import_react25.default.createElement("span",null,type),": ",import_react25.default.createElement(ErrorName,null,name),import_react25.default.createElement("br",null),lines.map((l,i)=>l.name?import_react25.default.createElement(import_react25.Fragment,{key:i},"  ","at ",import_react25.default.createElement(ErrorImportant,null,l.name)," (",import_react25.default.createElement(ErrorDetail,null,l.location),")",import_react25.default.createElement("br",null)):import_react25.default.createElement(import_react25.Fragment,{key:i},"  ","at ",import_react25.default.createElement(ErrorDetail,null,l.location),import_react25.default.createElement("br",null))))};var import_react26=__toESM(require("react")),import_theming33=require("@storybook/theming");var import_react_slot2=require("@radix-ui/react-slot"),import_client_logger2=require("@storybook/client-logger"),Button=(0,import_react26.forwardRef)(({asChild=!1,animation="none",size="small",variant="outline",padding="medium",disabled=!1,active=!1,onClick,...props},ref)=>{let Comp2="button";props.isLink&&(Comp2="a"),asChild&&(Comp2=import_react_slot2.Slot);let localVariant=variant,localSize=size,[isAnimating,setIsAnimating]=(0,import_react26.useState)(!1),handleClick=event=>{onClick&&onClick(event),animation!=="none"&&setIsAnimating(!0)};if((0,import_react26.useEffect)(()=>{let timer=setTimeout(()=>{isAnimating&&setIsAnimating(!1)},1e3);return()=>clearTimeout(timer)},[isAnimating]),props.primary&&(localVariant="solid",localSize="medium"),(props.secondary||props.tertiary||props.gray||props.outline||props.inForm)&&(localVariant="outline",localSize="medium"),props.small||props.isLink||props.primary||props.secondary||props.tertiary||props.gray||props.outline||props.inForm||props.containsIcon){let buttonContent=import_react26.default.Children.toArray(props.children).filter(e=>typeof e=="string"&&e!=="");(0,import_client_logger2.deprecate)(`Use of deprecated props in the button ${buttonContent.length>0?`"${buttonContent.join(" ")}"`:"component"} detected, see the migration notes at https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#new-ui-and-props-for-button-and-iconbutton-components`)}return import_react26.default.createElement(StyledButton,{as:Comp2,ref,variant:localVariant,size:localSize,padding,disabled,active,animating:isAnimating,animation,onClick:handleClick,...props})});Button.displayName="Button";var StyledButton=(0,import_theming33.styled)("button",{shouldForwardProp:prop=>(0,import_theming33.isPropValid)(prop)})(({theme,variant,size,disabled,active,animating,animation,padding})=>({border:0,cursor:disabled?"not-allowed":"pointer",display:"inline-flex",gap:"6px",alignItems:"center",justifyContent:"center",overflow:"hidden",padding:padding==="small"&&size==="small"?"0 7px":padding==="small"&&size==="medium"?"0 9px":size==="small"?"0 10px":size==="medium"?"0 12px":0,height:size==="small"?"28px":"32px",position:"relative",textAlign:"center",textDecoration:"none",transitionProperty:"background, box-shadow",transitionDuration:"150ms",transitionTimingFunction:"ease-out",verticalAlign:"top",whiteSpace:"nowrap",userSelect:"none",opacity:disabled?.5:1,margin:0,fontSize:`${theme.typography.size.s1}px`,fontWeight:theme.typography.weight.bold,lineHeight:"1",background:variant==="solid"?theme.color.secondary:variant==="outline"?theme.button.background:variant==="ghost"&&active?theme.background.hoverable:"transparent",...variant==="ghost"?{".sb-bar &":{background:active?curriedTransparentize$1(.9,theme.barTextColor):"transparent",color:active?theme.barSelectedColor:theme.barTextColor,"&:hover":{color:theme.barHoverColor,background:curriedTransparentize$1(.86,theme.barHoverColor)},"&:active":{color:theme.barSelectedColor,background:curriedTransparentize$1(.9,theme.barSelectedColor)},"&:focus":{boxShadow:`${rgba(theme.barHoverColor,1)} 0 0 0 1px inset`,outline:"none"}}}:{},color:variant==="solid"?theme.color.lightest:variant==="outline"?theme.input.color:variant==="ghost"&&active?theme.color.secondary:variant==="ghost"?theme.color.mediumdark:theme.input.color,boxShadow:variant==="outline"?`${theme.button.border} 0 0 0 1px inset`:"none",borderRadius:theme.input.borderRadius,flexShrink:0,"&:hover":{color:variant==="ghost"?theme.color.secondary:null,background:(()=>{let bgColor=theme.color.secondary;return variant==="solid"&&(bgColor=theme.color.secondary),variant==="outline"&&(bgColor=theme.button.background),variant==="ghost"?curriedTransparentize$1(.86,theme.color.secondary):theme.base==="light"?curriedDarken$1(.02,bgColor):curriedLighten$1(.03,bgColor)})()},"&:active":{color:variant==="ghost"?theme.color.secondary:null,background:(()=>{let bgColor=theme.color.secondary;return variant==="solid"&&(bgColor=theme.color.secondary),variant==="outline"&&(bgColor=theme.button.background),variant==="ghost"?theme.background.hoverable:theme.base==="light"?curriedDarken$1(.02,bgColor):curriedLighten$1(.03,bgColor)})()},"&:focus":{boxShadow:`${rgba(theme.color.secondary,1)} 0 0 0 1px inset`,outline:"none"},"> svg":{animation:animating&&animation!=="none"?`${theme.animation[animation]} 1000ms ease-out`:""}}));var import_react27=__toESM(require("react"));var IconButton=(0,import_react27.forwardRef)(({padding="small",variant="ghost",...props},ref)=>import_react27.default.createElement(Button,{padding,variant,ref,...props}));IconButton.displayName="IconButton";var import_theming36=require("@storybook/theming");var import_react28=__toESM(require("react")),import_theming34=require("@storybook/theming"),Wrapper2=import_theming34.styled.label(({theme})=>({display:"flex",borderBottom:`1px solid ${theme.appBorderColor}`,margin:"0 15px",padding:"8px 0","&:last-child":{marginBottom:"3rem"}})),Label=import_theming34.styled.span(({theme})=>({minWidth:100,fontWeight:theme.typography.weight.bold,marginRight:15,display:"flex",justifyContent:"flex-start",alignItems:"center",lineHeight:"16px"})),Field=({label,children,...props})=>import_react28.default.createElement(Wrapper2,{...props},label?import_react28.default.createElement(Label,null,import_react28.default.createElement("span",null,label)):null,children);Field.defaultProps={label:void 0};var import_react30=__toESM(require("react")),import_theming35=require("@storybook/theming");init_extends();init_objectWithoutPropertiesLoose();var React20=__toESM(require("react"));var import_react29=require("react"),updateRef=function(ref,value){if(typeof ref=="function"){ref(value);return}ref.current=value},useComposedRef=function(libRef,userRef){var prevUserRef=(0,import_react29.useRef)();return(0,import_react29.useCallback)(function(instance){libRef.current=instance,prevUserRef.current&&updateRef(prevUserRef.current,null),prevUserRef.current=userRef,userRef&&updateRef(userRef,instance)},[userRef])},use_composed_ref_esm_default=useComposedRef;var noop=function(){},_excluded2=["cacheMeasurements","maxRows","minRows","onChange","onHeightChange"],TextareaAutosize=function(_ref,userRef){_ref.cacheMeasurements,_ref.maxRows,_ref.minRows;var _ref$onChange=_ref.onChange,onChange=_ref$onChange===void 0?noop:_ref$onChange;_ref.onHeightChange;var props=_objectWithoutPropertiesLoose(_ref,_excluded2);props.value;var libRef=React20.useRef(null),ref=use_composed_ref_esm_default(libRef,userRef);return React20.useRef(0),React20.useRef(),React20.createElement("textarea",_extends({},props,{onChange,ref}))},index=React20.forwardRef(TextareaAutosize);var styleResets={appearance:"none",border:"0 none",boxSizing:"inherit",display:" block",margin:" 0",background:"transparent",padding:0,fontSize:"inherit",position:"relative"},styles=({theme})=>({...styleResets,transition:"box-shadow 200ms ease-out, opacity 200ms ease-out",color:theme.input.color||"inherit",background:theme.input.background,boxShadow:`${theme.input.border} 0 0 0 1px inset`,borderRadius:theme.input.borderRadius,fontSize:theme.typography.size.s2-1,lineHeight:"20px",padding:"6px 10px",boxSizing:"border-box",height:32,'&[type="file"]':{height:"auto"},"&:focus":{boxShadow:`${theme.color.secondary} 0 0 0 1px inset`,outline:"none"},"&[disabled]":{cursor:"not-allowed",opacity:.5},"&:-webkit-autofill":{WebkitBoxShadow:`0 0 0 3em ${theme.color.lightest} inset`},"&::placeholder":{color:theme.textMutedColor,opacity:1}}),sizes=({size})=>{switch(size){case"100%":return{width:"100%"};case"flex":return{flex:1};case"auto":default:return{display:"inline"}}},alignment=({align})=>{switch(align){case"end":return{textAlign:"right"};case"center":return{textAlign:"center"};case"start":default:return{textAlign:"left"}}},validation=({valid,theme})=>{switch(valid){case"valid":return{boxShadow:`${theme.color.positive} 0 0 0 1px inset !important`};case"error":return{boxShadow:`${theme.color.negative} 0 0 0 1px inset !important`};case"warn":return{boxShadow:`${theme.color.warning} 0 0 0 1px inset`};case void 0:case null:default:return{}}},Input=Object.assign((0,import_theming35.styled)((0,import_react30.forwardRef)(function({size,valid,align,...props},ref){return import_react30.default.createElement("input",{...props,ref})}))(styles,sizes,alignment,validation,{minHeight:32}),{displayName:"Input"}),Select=Object.assign((0,import_theming35.styled)((0,import_react30.forwardRef)(function({size,valid,align,...props},ref){return import_react30.default.createElement("select",{...props,ref})}))(styles,sizes,validation,{height:32,userSelect:"none",paddingRight:20,appearance:"menulist"}),{displayName:"Select"}),Textarea=Object.assign((0,import_theming35.styled)((0,import_react30.forwardRef)(function({size,valid,align,...props},ref){return import_react30.default.createElement(index,{...props,ref})}))(styles,sizes,alignment,validation,({height=400})=>({overflow:"visible",maxHeight:height})),{displayName:"Textarea"});var Form=Object.assign(import_theming36.styled.form({boxSizing:"border-box",width:"100%"}),{Field,Input,Select,Textarea,Button});var import_react33=__toESM(require("react")),LazyWithTooltip=(0,import_react33.lazy)(()=>Promise.resolve().then(()=>(init_WithTooltip(),WithTooltip_exports)).then(mod=>({default:mod.WithTooltip}))),WithTooltip=props=>import_react33.default.createElement(import_react33.Suspense,{fallback:import_react33.default.createElement("div",null)},import_react33.default.createElement(LazyWithTooltip,{...props})),LazyWithTooltipPure=(0,import_react33.lazy)(()=>Promise.resolve().then(()=>(init_WithTooltip(),WithTooltip_exports)).then(mod=>({default:mod.WithTooltipPure}))),WithTooltipPure2=props=>import_react33.default.createElement(import_react33.Suspense,{fallback:import_react33.default.createElement("div",null)},import_react33.default.createElement(LazyWithTooltipPure,{...props}));var import_react34=__toESM(require("react")),import_theming39=require("@storybook/theming");var Title2=import_theming39.styled.div(({theme})=>({fontWeight:theme.typography.weight.bold})),Desc2=import_theming39.styled.span(),Links=import_theming39.styled.div(({theme})=>({marginTop:8,textAlign:"center","> *":{margin:"0 8px",fontWeight:theme.typography.weight.bold}})),Message2=import_theming39.styled.div(({theme})=>({color:theme.color.defaultText,lineHeight:"18px"})),MessageWrapper=import_theming39.styled.div({padding:15,width:280,boxSizing:"border-box"}),TooltipMessage=({title,desc,links})=>import_react34.default.createElement(MessageWrapper,null,import_react34.default.createElement(Message2,null,title&&import_react34.default.createElement(Title2,null,title),desc&&import_react34.default.createElement(Desc2,null,desc)),links&&import_react34.default.createElement(Links,null,links.map(({title:linkTitle,...other})=>import_react34.default.createElement(Link2,{...other,key:linkTitle},linkTitle))));TooltipMessage.defaultProps={title:null,desc:null,links:null};var import_react35=__toESM(require("react")),import_theming40=require("@storybook/theming"),Note=import_theming40.styled.div(({theme})=>({padding:"2px 6px",lineHeight:"16px",fontSize:10,fontWeight:theme.typography.weight.bold,color:theme.color.lightest,boxShadow:"0 0 5px 0 rgba(0, 0, 0, 0.3)",borderRadius:4,whiteSpace:"nowrap",pointerEvents:"none",zIndex:-1,background:theme.base==="light"?"rgba(60, 60, 60, 0.9)":"rgba(0, 0, 0, 0.95)",margin:6})),TooltipNote=({note,...props})=>import_react35.default.createElement(Note,{...props},note);var import_react37=__toESM(require("react")),import_theming42=require("@storybook/theming");var import_react36=__toESM(require("react")),import_theming41=require("@storybook/theming"),import_memoizerific4=__toESM(require("memoizerific"));var Title3=(0,import_theming41.styled)(({active,loading,disabled,...rest})=>import_react36.default.createElement("span",{...rest}))(({theme})=>({color:theme.color.defaultText,fontWeight:theme.typography.weight.regular}),({active,theme})=>active?{color:theme.color.secondary,fontWeight:theme.typography.weight.bold}:{},({loading,theme})=>loading?{display:"inline-block",flex:"none",...theme.animation.inlineGlow}:{},({disabled,theme})=>disabled?{color:curriedTransparentize$1(.7,theme.color.defaultText)}:{}),Right=import_theming41.styled.span({display:"flex","& svg":{height:12,width:12,margin:"3px 0",verticalAlign:"top"},"& path":{fill:"inherit"}}),Center=import_theming41.styled.span({flex:1,textAlign:"left",display:"flex",flexDirection:"column"},({isIndented})=>isIndented?{marginLeft:24}:{}),CenterText=import_theming41.styled.span(({theme})=>({fontSize:"11px",lineHeight:"14px"}),({active,theme})=>active?{color:theme.color.secondary}:{},({theme,disabled})=>disabled?{color:theme.textMutedColor}:{}),Left=import_theming41.styled.span(({active,theme})=>active?{color:theme.color.secondary}:{},()=>({display:"flex",maxWidth:14})),Item=import_theming41.styled.a(({theme})=>({fontSize:theme.typography.size.s1,transition:"all 150ms ease-out",color:theme.color.dark,textDecoration:"none",cursor:"pointer",justifyContent:"space-between",lineHeight:"18px",padding:"7px 10px",display:"flex",alignItems:"center","& > * + *":{paddingLeft:10},"&:hover":{background:theme.background.hoverable},"&:hover svg":{opacity:1}}),({disabled})=>disabled?{cursor:"not-allowed"}:{}),getItemProps=(0,import_memoizerific4.default)(100)((onClick,href,LinkWrapper)=>{let result={};return onClick&&Object.assign(result,{onClick}),href&&Object.assign(result,{href}),LinkWrapper&&href&&Object.assign(result,{to:href,as:LinkWrapper}),result}),ListItem=({loading,title,center,right:right2,icon,active,disabled,isIndented,href,onClick,LinkWrapper,...rest})=>{let itemProps=getItemProps(onClick,href,LinkWrapper),commonProps={active,disabled};return import_react36.default.createElement(Item,{...commonProps,...rest,...itemProps},icon&&import_react36.default.createElement(Left,{...commonProps},icon),title||center?import_react36.default.createElement(Center,{isIndented:!icon&&isIndented},title&&import_react36.default.createElement(Title3,{...commonProps,loading},title),center&&import_react36.default.createElement(CenterText,{...commonProps},center)):null,right2&&import_react36.default.createElement(Right,{...commonProps},right2))};ListItem.defaultProps={loading:!1,title:import_react36.default.createElement("span",null,"Loading state"),center:null,right:null,active:!1,disabled:!1,href:null,LinkWrapper:null,onClick:null};var ListItem_default=ListItem;var List=import_theming42.styled.div({minWidth:180,overflow:"hidden",overflowY:"auto",maxHeight:15.5*32},({theme})=>({borderRadius:theme.appBorderRadius})),Item2=props=>{let{LinkWrapper,onClick:onClickFromProps,id,isIndented,...rest}=props,{title,href,active}=rest,onClick=(0,import_react37.useCallback)(event=>{onClickFromProps(event,rest)},[onClickFromProps]),hasOnClick=!!onClickFromProps;return import_react37.default.createElement(ListItem_default,{title,active,href,id:`list-item-${id}`,LinkWrapper,isIndented,...rest,...hasOnClick?{onClick}:{}})},TooltipLinkList=({links,LinkWrapper})=>{let hasIcon=links.some(link=>link.icon);return import_react37.default.createElement(List,null,links.map(({isGatsby,...p})=>import_react37.default.createElement(Item2,{key:p.id,LinkWrapper:isGatsby?LinkWrapper:null,isIndented:hasIcon,...p})))};TooltipLinkList.defaultProps={LinkWrapper:ListItem_default.defaultProps.LinkWrapper};var import_react43=__toESM(require("react")),import_theming48=require("@storybook/theming"),import_csf2=require("@storybook/csf");var import_react38=__toESM(require("react")),import_theming43=require("@storybook/theming"),isLink=obj=>typeof obj.props.href=="string",isButton=obj=>typeof obj.props.href!="string";function ForwardRefFunction({children,...rest},ref){let o={props:rest,ref};if(isLink(o))return import_react38.default.createElement("a",{ref:o.ref,...o.props},children);if(isButton(o))return import_react38.default.createElement("button",{ref:o.ref,type:"button",...o.props},children);throw new Error("invalid props")}var ButtonOrLink=(0,import_react38.forwardRef)(ForwardRefFunction);ButtonOrLink.displayName="ButtonOrLink";var TabButton=(0,import_theming43.styled)(ButtonOrLink,{shouldForwardProp:import_theming43.isPropValid})({whiteSpace:"normal",display:"inline-flex",overflow:"hidden",verticalAlign:"top",justifyContent:"center",alignItems:"center",textAlign:"center",textDecoration:"none","&:empty":{display:"none"},"&[hidden]":{display:"none"}},({theme})=>({padding:"0 15px",transition:"color 0.2s linear, border-bottom-color 0.2s linear",height:40,lineHeight:"12px",cursor:"pointer",background:"transparent",border:"0 solid transparent",borderTop:"3px solid transparent",borderBottom:"3px solid transparent",fontWeight:"bold",fontSize:13,"&:focus":{outline:"0 none",borderBottomColor:theme.barSelectedColor}}),({active,textColor,theme})=>active?{color:textColor||theme.barSelectedColor,borderBottomColor:theme.barSelectedColor}:{color:textColor||theme.barTextColor,borderBottomColor:"transparent","&:hover":{color:theme.barHoverColor}});TabButton.displayName="TabButton";var IconPlaceholder=import_theming43.styled.div(({theme})=>({width:14,height:14,backgroundColor:theme.appBorderColor,animation:`${theme.animation.glow} 1.5s ease-in-out infinite`})),IconButtonSkeletonWrapper=import_theming43.styled.div(()=>({marginTop:6,padding:7,height:28})),IconButtonSkeleton=()=>import_react38.default.createElement(IconButtonSkeletonWrapper,null,import_react38.default.createElement(IconPlaceholder,null));var import_react39=__toESM(require("react")),import_theming44=require("@storybook/theming");init_ScrollArea();var Side=import_theming44.styled.div({display:"flex",whiteSpace:"nowrap",flexBasis:"auto",marginLeft:3,marginRight:3},({scrollable})=>scrollable?{flexShrink:0}:{},({left:left2})=>left2?{"& > *":{marginLeft:4}}:{},({right:right2})=>right2?{marginLeft:30,"& > *":{marginRight:4}}:{});Side.displayName="Side";var UnstyledBar=({children,className,scrollable})=>scrollable?import_react39.default.createElement(ScrollArea,{vertical:!1,className},children):import_react39.default.createElement("div",{className},children),Bar=(0,import_theming44.styled)(UnstyledBar)(({theme,scrollable=!0})=>({color:theme.barTextColor,width:"100%",height:40,flexShrink:0,overflow:scrollable?"auto":"hidden",overflowY:"hidden"}),({theme,border=!1})=>border?{boxShadow:`${theme.appBorderColor}  0 -1px 0 0 inset`,background:theme.barBg}:{});Bar.displayName="Bar";var BarInner=import_theming44.styled.div(({bgColor})=>({display:"flex",justifyContent:"space-between",position:"relative",flexWrap:"nowrap",flexShrink:0,height:40,backgroundColor:bgColor||""})),FlexBar=({children,backgroundColor,className,...rest})=>{let[left2,right2]=import_react39.Children.toArray(children);return import_react39.default.createElement(Bar,{className:`sb-bar ${className}`,...rest},import_react39.default.createElement(BarInner,{bgColor:backgroundColor},import_react39.default.createElement(Side,{scrollable:rest.scrollable,left:!0},left2),right2?import_react39.default.createElement(Side,{right:!0},right2):null))};FlexBar.displayName="FlexBar";var import_theming45=require("@storybook/theming"),import_react40=__toESM(require("react")),VisuallyHidden=import_theming45.styled.div(({active})=>active?{display:"block"}:{display:"none"}),childrenToList=children=>import_react40.Children.toArray(children).map(({props:{title,id,color:color2,children:childrenOfChild}})=>{let content=Array.isArray(childrenOfChild)?childrenOfChild[0]:childrenOfChild;return{title,id,...color2?{color:color2}:{},render:typeof content=="function"?content:({active})=>import_react40.default.createElement(VisuallyHidden,{active,role:"tabpanel"},content)}});var import_react41=__toESM(require("react")),import_csf=require("@storybook/csf"),import_theming46=require("@storybook/theming");init_WithTooltip();var CollapseIcon=import_theming46.styled.span(({theme,isActive})=>({display:"inline-block",width:0,height:0,marginLeft:8,color:isActive?theme.color.secondary:theme.color.mediumdark,borderRight:"3px solid transparent",borderLeft:"3px solid transparent",borderTop:"3px solid",transition:"transform .1s ease-out"})),AddonButton=(0,import_theming46.styled)(TabButton)(({active,theme,preActive})=>`
  ...
  `);function useList(list){let tabBarRef=(0,import_react41.useRef)(),addonsRef=(0,import_react41.useRef)(),tabRefs=(0,import_react41.useRef)(new Map),{width:tabBarWidth=1}=useResizeObserver({ref:tabBarRef}),[visibleList,setVisibleList]=(0,import_react41.useState)(list),[invisibleList,setInvisibleList]=(0,import_react41.useState)([]),previousList=(0,import_react41.useRef)(list),AddonTab=(0,import_react41.useCallback)(({menuName,actions})=>{let isAddonsActive=invisibleList.some(({active})=>active),[isTooltipVisible,setTooltipVisible]=(0,import_react41.useState)(!1);return import_react41.default.createElement(import_react41.default.Fragment,null,import_react41.default.createElement(WithToolTipState,{interactive:!0,visible:isTooltipVisible,onVisibleChange:setTooltipVisible,placement:"bottom",delayHide:100,tooltip:import_react41.default.createElement(TooltipLinkList,{links:invisibleList.map(({title,id,color:color2,active})=>({id,title,color:color2,active,onClick:e=>{e.preventDefault(),actions.onSelect(id)}}))})},import_react41.default.createElement(AddonButton,{ref:addonsRef,active:isAddonsActive,preActive:isTooltipVisible,style:{visibility:invisibleList.length?"visible":"hidden"},"aria-hidden":!invisibleList.length,className:"tabbutton",type:"button",role:"tab"},menuName,import_react41.default.createElement(CollapseIcon,{className:"addon-collapsible-icon",isActive:isAddonsActive||isTooltipVisible}))),invisibleList.map(({title,id,color:color2},index2)=>{let indexId=`index-${index2}`;return import_react41.default.createElement(TabButton,{id:`tabbutton-${(0,import_csf.sanitize)(id)??indexId}`,style:{visibility:"hidden"},"aria-hidden":!0,tabIndex:-1,ref:ref=>{tabRefs.current.set(id,ref)},className:"tabbutton",type:"button",key:id,textColor:color2,role:"tab"},title)}))},[invisibleList]),setTabLists=(0,import_react41.useCallback)(()=>{if(!tabBarRef.current||!addonsRef.current)return;let{x:x3,width}=tabBarRef.current.getBoundingClientRect(),{width:widthAddonsTab}=addonsRef.current.getBoundingClientRect(),rightBorder=invisibleList.length?x3+width-widthAddonsTab:x3+width,newVisibleList=[],widthSum=0,newInvisibleList=list.filter(item=>{let{id}=item,tabButton=tabRefs.current.get(id),{width:tabWidth=0}=tabButton?.getBoundingClientRect()||{},crossBorder=x3+widthSum+tabWidth>rightBorder;return(!crossBorder||!tabButton)&&newVisibleList.push(item),widthSum+=tabWidth,crossBorder});(newVisibleList.length!==visibleList.length||previousList.current!==list)&&(setVisibleList(newVisibleList),setInvisibleList(newInvisibleList),previousList.current=list)},[invisibleList.length,list,visibleList]);return(0,import_react41.useLayoutEffect)(setTabLists,[setTabLists,tabBarWidth]),{tabRefs,addonsRef,tabBarRef,visibleList,invisibleList,AddonTab}}var import_react42=__toESM(require("react")),import_theming47=require("@storybook/theming"),Wrapper4=import_theming47.styled.div(({theme})=>({height:"100%",display:"flex",padding:30,alignItems:"center",justifyContent:"center",flexDirection:"column",gap:15,background:theme.background.content})),Content=import_theming47.styled.div({display:"flex",flexDirection:"column",gap:4,maxWidth:415}),Title4=import_theming47.styled.div(({theme})=>({fontWeight:theme.typography.weight.bold,fontSize:theme.typography.size.s2-1,textAlign:"center",color:theme.textColor})),Description=import_theming47.styled.div(({theme})=>({fontWeight:theme.typography.weight.regular,fontSize:theme.typography.size.s2-1,textAlign:"center",color:theme.textMutedColor})),EmptyTabContent=({title,description,footer})=>import_react42.default.createElement(Wrapper4,null,import_react42.default.createElement(Content,null,import_react42.default.createElement(Title4,null,title),description&&import_react42.default.createElement(Description,null,description)),footer);var ignoreSsrWarning2="/* emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason */",Wrapper5=import_theming48.styled.div(({theme,bordered})=>bordered?{backgroundClip:"padding-box",border:`1px solid ${theme.appBorderColor}`,borderRadius:theme.appBorderRadius,overflow:"hidden",boxSizing:"border-box"}:{},({absolute})=>absolute?{width:"100%",height:"100%",boxSizing:"border-box",display:"flex",flexDirection:"column"}:{display:"block"}),TabBar=import_theming48.styled.div({overflow:"hidden","&:first-of-type":{marginLeft:-3},whiteSpace:"nowrap",flexGrow:1});TabBar.displayName="TabBar";var Content2=import_theming48.styled.div({display:"block",position:"relative"},({theme})=>({fontSize:theme.typography.size.s2-1,background:theme.background.content}),({bordered,theme})=>bordered?{borderRadius:`0 0 ${theme.appBorderRadius-1}px ${theme.appBorderRadius-1}px`}:{},({absolute,bordered})=>absolute?{height:`calc(100% - ${bordered?42:40}px)`,position:"absolute",left:0+(bordered?1:0),right:0+(bordered?1:0),bottom:0+(bordered?1:0),top:40+(bordered?1:0),overflow:"auto",[`& > *:first-child${ignoreSsrWarning2}`]:{position:"absolute",left:0+(bordered?1:0),right:0+(bordered?1:0),bottom:0+(bordered?1:0),top:0+(bordered?1:0),height:`calc(100% - ${bordered?2:0}px)`,overflow:"auto"}}:{}),TabWrapper=({active,render,children})=>import_react43.default.createElement(VisuallyHidden,{active},render?render():children);var Tabs=(0,import_react43.memo)(({children,selected,actions,absolute,bordered,tools,backgroundColor,id:htmlId,menuName,emptyState,showToolsWhenEmpty})=>{let idList=childrenToList(children).map(i=>i.id).join(","),list=(0,import_react43.useMemo)(()=>childrenToList(children).map((i,index2)=>({...i,active:selected?i.id===selected:index2===0})),[selected,idList]),{visibleList,tabBarRef,tabRefs,AddonTab}=useList(list),EmptyContent=emptyState??import_react43.default.createElement(EmptyTabContent,{title:"Nothing found"});return!showToolsWhenEmpty&&list.length===0?EmptyContent:import_react43.default.createElement(Wrapper5,{absolute,bordered,id:htmlId},import_react43.default.createElement(FlexBar,{scrollable:!1,border:!0,backgroundColor},import_react43.default.createElement(TabBar,{style:{whiteSpace:"normal"},ref:tabBarRef,role:"tablist"},visibleList.map(({title,id,active,color:color2},index2)=>{let indexId=`index-${index2}`;return import_react43.default.createElement(TabButton,{id:`tabbutton-${(0,import_csf2.sanitize)(id)??indexId}`,ref:ref=>{tabRefs.current.set(id,ref)},className:`tabbutton ${active?"tabbutton-active":""}`,type:"button",key:id,active,textColor:color2,onClick:e=>{e.preventDefault(),actions.onSelect(id)},role:"tab"},typeof title=="function"?import_react43.default.createElement("title",null):title)}),import_react43.default.createElement(AddonTab,{menuName,actions})),tools),import_react43.default.createElement(Content2,{id:"panel-tab-content",bordered,absolute},list.length?list.map(({id,active,render})=>import_react43.default.createElement(render,{key:id,active},null)):EmptyContent))});Tabs.displayName="Tabs";Tabs.defaultProps={id:null,children:null,tools:null,selected:null,absolute:!1,bordered:!1,menuName:"Tabs"};var TabsState=class extends import_react43.Component{constructor(props){super(props);this.handlers={onSelect:id=>this.setState({selected:id})};this.state={selected:props.initial}}static{this.defaultProps={children:[],initial:null,absolute:!1,bordered:!1,backgroundColor:"",menuName:void 0}}render(){let{bordered=!1,absolute=!1,children,backgroundColor,menuName}=this.props,{selected}=this.state;return import_react43.default.createElement(Tabs,{bordered,absolute,selected,backgroundColor,menuName,actions:this.handlers},children)}};var import_react44=__toESM(require("react")),import_theming49=require("@storybook/theming"),Separator=import_theming49.styled.span(({theme})=>({width:1,height:20,background:theme.appBorderColor,marginLeft:2,marginRight:2}),({force})=>force?{}:{"& + &":{display:"none"}});Separator.displayName="Separator";var interleaveSeparators=list=>list.reduce((acc,item,index2)=>item?import_react44.default.createElement(import_react44.Fragment,{key:item.id||item.key||`f-${index2}`},acc,index2>0?import_react44.default.createElement(Separator,{key:`s-${index2}`}):null,item.render()||item):acc,null);var import_react45=__toESM(require("react")),usePrevious=value=>{let ref=(0,import_react45.useRef)();return(0,import_react45.useEffect)(()=>{ref.current=value},[value]),ref.current},useUpdate=(update,value)=>{let previousValue=usePrevious(value);return update?value:previousValue},AddonPanel=({active,children})=>import_react45.default.createElement("div",{hidden:!active},useUpdate(active,children));var import_react46=__toESM(require("react")),StorybookIcons=__toESM(require("@storybook/icons")),import_theming50=require("@storybook/theming"),import_client_logger3=require("@storybook/client-logger"),NEW_ICON_MAP=StorybookIcons,Svg=import_theming50.styled.svg`
  display: inline-block;
...
`;var import_icons2=require("@storybook/icons"),LoaderWrapper=import_theming52.styled.div(({size=32})=>({borderRadius:"50%",cursor:"progress",display:"inline-block",overflow:"hidden",position:"absolute",transition:"all 200ms ease-out",verticalAlign:"top",top:"50%",left:"50%",marginTop:-(size/2),marginLeft:-(size/2),height:size,width:size,zIndex:4,borderWidth:2,borderStyle:"solid",borderColor:"rgba(97, 97, 97, 0.29)",borderTopColor:"rgb(100,100,100)",animation:`${rotate360} 0.7s linear infinite`,mixBlendMode:"difference"})),ProgressWrapper=import_theming52.styled.div({position:"absolute",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",width:"100%",height:"100%"}),ProgressTrack=import_theming52.styled.div(({theme})=>({position:"relative",width:"80%",marginBottom:"0.75rem",maxWidth:300,height:5,borderRadius:5,background:curriedTransparentize$1(.8,theme.color.secondary),overflow:"hidden",cursor:"progress"})),ProgressBar=import_theming52.styled.div(({theme})=>({position:"absolute",top:0,left:0,height:"100%",background:theme.color.secondary})),ProgressMessage=import_theming52.styled.div(({theme})=>({minHeight:"2em",fontSize:`${theme.typography.size.s1}px`,color:theme.barTextColor})),ErrorIcon=(0,import_theming52.styled)(import_icons2.LightningOffIcon)(({theme})=>({width:20,height:20,marginBottom:"0.5rem",color:theme.textMutedColor})),ellipsis=import_theming52.keyframes`
  from { content: "..." }
  33% { content: "." }
  66% { content: ".." }
  to { content: "..." }
`,Ellipsis=import_theming52.styled.span({"&::after":{content:"'...'",animation:`${ellipsis} 1s linear infinite`,animationDelay:"1s",display:"inline-block",width:"1em",height:"auto"}}),Loader=({progress,error,size,...props})=>{if(error)return import_react49.default.createElement(ProgressWrapper,{"aria-label":error.toString(),"aria-live":"polite",role:"status",...props},import_react49.default.createElement(ErrorIcon,null),import_react49.default.createElement(ProgressMessage,null,error.message));if(progress){let{value,modules}=progress,{message}=progress;return modules&&(message+=` ${modules.complete} / ${modules.total} modules`),import_react49.default.createElement(ProgressWrapper,{"aria-label":"Content is loading...","aria-live":"polite","aria-valuemin":0,"aria-valuemax":100,"aria-valuenow":value*100,"aria-valuetext":message,role:"progressbar",...props},import_react49.default.createElement(ProgressTrack,null,import_react49.default.createElement(ProgressBar,{style:{width:`${value*100}%`}})),import_react49.default.createElement(ProgressMessage,null,message,value<1&&import_react49.default.createElement(Ellipsis,{key:message})))}return import_react49.default.createElement(LoaderWrapper,{"aria-label":"Content is loading...","aria-live":"polite",role:"status",size,...props})};function parseQuery(queryString){let query={},pairs=queryString.split("&");for(let i=0;i<pairs.length;i++){let pair=pairs[i].split("=");query[decodeURIComponent(pair[0])]=decodeURIComponent(pair[1]||"")}return query}var getStoryHref=(baseUrl,storyId,additionalParams={})=>{let[url,paramsStr]=baseUrl.split("?"),params=paramsStr?{...parseQuery(paramsStr),...additionalParams,id:storyId}:{...additionalParams,id:storyId};return`${url}?${Object.entries(params).map(item=>`${item[0]}=${item[1]}`).join("&")}`};var import_react50=__toESM(require("react")),import_theming53=require("@storybook/theming"),Code3=import_theming53.styled.pre`
  line-height: 18px;
  padding: 11px 1rem;
  white-space: pre-wrap;
  background: rgba(0, 0, 0, 0.05);
  color: ${import_theming53.color.darkest};
  border-radius: 3px;
  margin: 1rem 0;
  width: 100%;
  display: block;
  overflow: hidden;
  font-family: ${import_theming53.typography.fonts.mono};
  font-size: ${import_theming53.typography.size.s2-1}px;
`,ClipboardCode=({code,...props})=>import_react50.default.createElement(Code3,{id:"clipboard-code",...props},code);var components2=components,resetComponents={};Object.keys(components).forEach(key=>{resetComponents[key]=(0,import_react51.forwardRef)((props,ref)=>(0,import_react51.createElement)(key,{...props,ref}))});0&&(module.exports={A,ActionBar,AddonPanel,Badge,Bar,Blockquote,Button,ClipboardCode,Code,DL,Div,DocumentWrapper,EmptyTabContent,ErrorFormatter,FlexBar,Form,H1,H2,H3,H4,H5,H6,HR,IconButton,IconButtonSkeleton,Icons,Img,LI,Link,ListItem,Loader,OL,P,Placeholder,Pre,ResetWrapper,ScrollArea,Separator,Spaced,Span,StorybookIcon,StorybookLogo,Symbols,SyntaxHighlighter,TT,TabBar,TabButton,TabWrapper,Table,Tabs,TabsState,TooltipLinkList,TooltipMessage,TooltipNote,UL,WithTooltip,WithTooltipPure,Zoom,codeCommon,components,createCopyToClipboardFunction,getStoryHref,icons,interleaveSeparators,nameSpaceClassNames,resetComponents,withReset});
